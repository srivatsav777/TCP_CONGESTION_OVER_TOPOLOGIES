...
class NetworkTopo(Topo):
    def build(self, **_opts):
        ...
        r2 = self.addHost('r2', cls=LinuxRouter, ip='142.0.1.2/16')
        r3 = self.addHost('r3', cls=LinuxRouter, ip='143.0.1.2/16')
        r4 = self.addHost('r4', cls=LinuxRouter, ip='144.0.1.2/16')
        r5 = self.addHost('r5', cls=LinuxRouter, ip='145.0.1.2/16')
        r6 = self.addHost('r6', cls=LinuxRouter, ip='146.0.1.2/16')
        r7 = self.addHost('r7', cls=LinuxRouter, ip='147.0.1.2/16')
        r8 = self.addHost('r8', cls=LinuxRouter, ip='148.0.1.2/16')
        ...
        self.addLink(r1,r8,
                    intfName1='r1-eth1',
                    intfName2='r8-eth2',
                    params1={'ip': '156.0.1.2/16'},
                    params2={'ip': '156.0.1.1/16'})
        ...
        self.addLink(r5,r6,
                    intfName1='r5-eth2',
                    intfName2='r6-eth1',
                    params1={'ip': '153.0.1.1/16'},
                    params2={'ip': '153.0.1.2/16'})
        ...
        self.addLink(r7,r8,
                    intfName1='r7-eth2',
                    intfName2='r8-eth1',
                    params1={'ip': '155.0.1.1/16'},
                    params2={'ip': '155.0.1.2/16'})
...
def run():
    ...
    info(net['r1'].cmd("ip addr add 156.0.1.2/16 r1-eth1"))
    info(net['r1'].cmd("ip addr add 149.0.1.1/16 r1-eth2"))

    info(net['r2'].cmd("ip addr add 149.0.1.2/16 r2-eth1"))
    info(net['r2'].cmd("ip addr add 150.0.1.1/16 r2-eth2"))
    #info(net['r2'].cmd("ip addr add 146.0.1.1/16 r2-eth3"))

    info(net['r3'].cmd("ip addr add 150.0.1.2/16 r3-eth1"))
    info(net['r3'].cmd("ip addr add 151.0.1.1/16 r3-eth2"))

    info(net['r4'].cmd("ip addr add 151.0.1.2/16 r4-eth1"))
    info(net['r4'].cmd("ip addr add 152.0.1.1/16 r4-eth2"))

    info(net['r5'].cmd("ip addr add 152.0.1.2/16 r5-eth1"))
    info(net['r5'].cmd("ip addr add 153.0.1.1/16 r5-eth2"))

    info(net['r6'].cmd("ip addr add 153.0.1.2/16 r6-eth1"))
    info(net['r6'].cmd("ip addr add 154.0.1.1/16 r6-eth2"))

    info(net['r7'].cmd("ip addr add 154.0.1.2/16 r7-eth1"))
    info(net['r7'].cmd("ip addr add 155.0.1.1/16 r7-eth2"))
    
    info(net['r8'].cmd("ip addr add 155.0.1.2/16 r8-eth1"))
    info(net['r8'].cmd("ip addr add 156.0.1.1/16 r8-eth2"))
